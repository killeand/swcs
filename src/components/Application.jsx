...
const CHAR_PAGES = [
    {url:"details",icon:"bi-journal-text",name:"Character Details",component:(<p>Component</p>)},
        ...
        <HashRouter>
            <div className="flex flex-col md:flex-row flex-grow">
                <header className="p-0 min-w-fit">
                    <div className="p-2 flex flex-row justify-between items-center bg-gradient-to-b from-sky-800 to-white rounded-xl">
                        <img className="rounded-full border border-black max-h-10 md:mx-auto" />
